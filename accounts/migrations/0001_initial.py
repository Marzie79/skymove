    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', utils.custom_fields.FarsiCharField(error_messages={'max_length': 'This email has already been registered.'}, max_length=30, verbose_name='First name')),
                ...
                ('company_name', utils.custom_fields.FarsiCharField(blank=True, error_messages={'max_length': 'This email has already been registered.'}, max_length=40, null=True, verbose_name='Company name')),
