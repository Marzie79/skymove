...
class Statement(models.Model):
    ...
    shipment = models.ForeignKey("form.Shipment", blank=True, null=True, on_delete=models.SET_NULL)
    courier = models.ForeignKey("form.Courier", blank=True, null=True, on_delete=models.SET_NULL)
    ...
    currency = models.CharField(null=True, blank=True, max_length=255, choices=CURRENCY_STATUS)
