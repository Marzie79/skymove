...
class HomeVideo(models.Model):
    video = models.FileField(
        ...
        upload_to="video_uploaded/",
        help_text=_("Size of video should be under 50 meg."),
    )
...
class ABoutUsHome(models.Model):
    ...
    title_fa = FarsiCharField(
        verbose_name=_("Title Persian"), max_length=50, null=True, blank=True
    )
    description = tinymce_models.HTMLField(verbose_name=_("Description"))
    description_fa = tinymce_models.HTMLField(
        verbose_name=_("Description Persian"), null=True, blank=True
    )
    active = models.BooleanField(
        verbose_name=_("Active"),
        default=True,
        help_text=_(
            "If you set this field true this information is shown in about us in home page."
        ),
    )
...
class SocialNetwork(models.Model):
    ...
    email = models.EmailField(
        verbose_name=_("Email"), validators=[validate_email], max_length=255
    )
    address = FarsiTextField(verbose_name=_("Address"), null=True, blank=True)
    address_fa = FarsiTextField(
        verbose_name=_("Address Persian"), null=True, blank=True
    )
    map = models.TextField(
        verbose_name=_("Map"),
        help_text=_("Enter iframe tag from google map."),
        null=True,
        blank=True,
    )
    whats_app_phone_number = PhoneNumberField(
        verbose_name=_("Whats app phone number"),
        null=True,
        blank=True,
    ...
    active = models.BooleanField(
        ...
        default=True,
        help_text=_(
            "If you set this field true this information is shown in footer of pages."
        ),
    )
